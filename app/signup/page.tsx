      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 border-2" style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="name" className="block text-sm font-medium mb-2" style={{ color: '#00d9ff' }}>
                Name
              </label>
              <Input
                id="name"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium mb-2" style={{ color: '#00d9ff' }}>
                Confirm Password
              </label>
              <Input
                id="confirmPassword"
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <Link href="/login" className="font-semibold hover:underline" style={{ color: '#ff0080' }}>
                Sign in
              </Link>
            </p>
          </div>
